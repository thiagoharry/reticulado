...
não-inteiros, usaremos o \monoesoaco{mpq\_t}, um tipo capaz de
...
Agora para multiplicar um número, ao invés de definirmos uma macro
...
pois só temos acesso ao \monoespaco{bn\_context} de dentro do
...
% Número de número real quando número é inteiro


Também podemos querer converter de \monoespaco{int} para
números, de \monoespaco{int} para números reais,
de \monoespaco{double} para números, de \monoespaco{double} para
números reais, ou ainda passar de número pra \monoespaco{int}
ou \monoespaco{double}, ou de número real para \monoespaco{int}
ou \monoespaco{double}.

Caso estejamos usando como números os tipos básicos \monoespaco{int}
...
outra. E para ler um número de um \monoespaco{int} e também para
um \monoespaco{int}, e também fazer conversões de tipo:
...
Para copiar e converter números de \monoespaco{int}, usamos a função:
...
Como estamos usando o tipo \monoespaco{bool}, introduzido na linguagem
...
para \monoespaco{int} e também para \monoespaco{double} no caso de
...
Converter um número real de ponto fixo para um \monoespaco{double}
...
Como podemos retornar \monoespaco{INFINITY}, devemos inserir o
